...
foundApis.readReportConfig = function (clusters, cId, payload, _afMsg, callback) {
    var readCfgRptRsps = [];
...
foundApis.discover = function (clusters, cId, payload, _afMsg, callback) {
    ...
    _.forEach(attrs, function (_info, id) {
